...
class TestPipelineSmoke:
    ...
    def test_pipeline_has_legs_or_explains_why_not(self):
        ...
        pipeline = PredictionPipeline()
        result = pipeline.run()
        # n_candidate_legs is an integer (may be 0 for demo with no upcoming games)
...
class TestTrainingSmoke:
    def test_training_runs(self):
        ...
        # Should either succeed or report insufficient_data
...
class TestBacktestSmoke:
    def test_backtest_runs(self):
        ...
        backtester = WalkForwardBacktester(min_train_samples=20, step_size=5)
